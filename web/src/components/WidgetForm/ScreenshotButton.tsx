...
export const ScreenshotButton = ({ screenshot, onScreenshotTook }: ScreenshotButtonProps) => {
    ...
    return (
        <button
            ...
            className="p-2 bg-zinc-800 rounded-md border-transparent hover:bg-zinc-900 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
        >
